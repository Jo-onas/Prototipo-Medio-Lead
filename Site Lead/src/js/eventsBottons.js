...
let programacao = document.getElementById('btn-Programacao').addEventListener('click', () => {
    ...
    subtitle.innerHTML= 'PROGRAMAÇÃO BLA BLA BLA' //Altere aqui a descrição
    img.innerHTML = '<img src="images/imagem.jpg" alt="">' //Altere aqui o caminho da imagem
...
let marketing = document.getElementById('btn-Marketing').addEventListener('click', () => {
    ...
    subtitle.innerHTML= 'MARKETING BLA BLA BLA'  //Altere aqui a descrição
    img.innerHTML = '<img src="images/instagram.png" alt="">' //Altere aqui o caminho da imagem
    //imagem só pra ver que tá funcionando
})
let producao = document.getElementById('btn-Producao').addEventListener('click', () => {
    ...
    subtitle.innerHTML= 'PRODUÇÃO BLA BLA BLA' //Altere aqui a descrição
    img.innerHTML = '<img src="images/alura.png" alt="">' //Altere aqui o caminho da imagem
    //imagem só pra ver que tá funcionando
})
